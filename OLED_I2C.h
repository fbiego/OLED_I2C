...
class OLED
{
	public:
		...
		void	printTime(int hr, int mn, int sc, int x, int y, bool fill, char divider='.', char filler=' ');
		...
		void	drawRectFillInv(int x1, int y1, int x2, int y2);
