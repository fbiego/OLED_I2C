...
void OLED::drawRectFill(int x1, int y1, int x2, int y2)
{
	int tmp;
...
void OLED::drawRectFillInv(int x1, int y1, int x2, int y2)
{
	int tmp;
...
void OLED::printTime(int hr, int mn, int sc, int x, int y,  bool fill, char divider, char filler)
{
	char st[9];
	int pos = 0;
